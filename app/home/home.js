        ...
        $routeProvider
            .when('/home', {
                ...
                function($scope, $routeParams, $location, toastr, downGitService) {
                    ...
                    var templateUrl = "^https?:\/\/github.com\/alswnet\/NocheProgramacion\/.+";
                    ...
                    if ($scope.url.match(templateUrl)) {
                        ...
                        toastr.warning("Invalid URL! Must begin with https://github.com/alswnet/NocheProgramacion/", {iconClass: 'toast-down'});
                    }
